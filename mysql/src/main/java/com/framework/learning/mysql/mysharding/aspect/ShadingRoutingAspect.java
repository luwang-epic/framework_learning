package com.framework.learning.mysql.mysharding.aspect;
...
import com.framework.learning.mysql.mysharding.exception.ParamsNotContainsRoutingFieldException;
...
public class ShadingRoutingAspect {
    ...
    @Pointcut("@annotation(com.framework.learning.mysql.mysharding.annotation.ShardingRouter)")
